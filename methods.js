...
function getUserById(array, id) {
    array.find((element) => { if (element.id == id) { console.log(element) } })
}
...
function getUsersGeo(array, id) {
    const ar = array.find((element) => element.id === id)
    return ar.address.geo
}
...
function getUsersCompany(array, id) {
    const it = array.find((element) => element.id === id)
    return it.company
}
...
function changePhone(array, id, phon) {
    const chang = array.map((element) => {
        if (element.id == id) {
            element.phone = phon
            return element
        }
...
// console.log(changePhone(users, 10, '898373673'));